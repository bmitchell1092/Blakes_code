function BHV = m_bhv_read(varargin)
% SYNTAX:
...
writeversion = m_bhv_write(4, 0, 0); %check for the currently-installed version of "bhv_write" as an indicator if the file version being read may be incompatible
...
rmlist = {'NumTimingFiles' 'NumStimuli' 'NumBehavioralCodesUsed' 'NumConds' 'ObjectsPerCond' 'Padding' 'NumXEyePoints' 'NumYEyePoints' 'NumXJoyPoints' 'NumYJoyPoints' 'NumGenPoints'};
