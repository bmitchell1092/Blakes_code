...
if ~any(strcmp(ext,{'.gromGrating_di','.gRFORIGrating_di','.gRFSFGrating_di','.gROMGrating_di','.gCINTEROCGrating_di','.gCOSINTEROCGrating_di','.gRFSIZEGrating_di','.gINTEROCORIGrating_di','.gMCOSINTEROCGrating_di','.gCONEGrating_di'}));
...
elseif n < datenum('10/06/2016','mm/dd/yyyy')
