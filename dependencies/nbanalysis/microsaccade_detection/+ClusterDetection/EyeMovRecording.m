classdef EyeMovRecording < ClusterDetection.DataDB
    ...
    properties (Constant = true)
        ...
        TRIAL_CROP_BEGINING = .01; % seconds to ignore at the begining of the trial
        TRIAL_CROP_END = 0.01; % seconds to ignore at the end of the trial
        TRIAL_MINIMUM_DURATION = .01; % seconds
        
        VALID_MINIMUM_DURATION = 0.01; % discard periods of continuos good data that are too short
