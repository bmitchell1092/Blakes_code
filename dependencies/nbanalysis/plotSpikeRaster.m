...
%fh=findall(0,'type','figure'); if isempty(fh), figH = 1,else figH = fh + 1; end
%clear figH
global gfigH;
if isempty(gfigH) | ~isfield(gfigH,'figH')
    figure,
else
    figure(gfigH.figH);
end

if isfield(gfigH,'row')
subplot(gfigH.row,gfigH.col,gfigH.N);
end
